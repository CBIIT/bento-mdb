...
def update_c1_upper_flow() -> None:
    ...
    c1_qa_key = f"{current_date}__cloud-one-mdb-qa.graphml"
    logger.info("Importing to cloud-one-mdb-stage from cloudone-mdb-data bucket")
    run_deployment(
        name="mdb-import-s3/mdb-import-s3-prod",
        parameters={
    ...
    run_deployment(
        name="mdb-prune-prerelease/prune-prerelease-prod",
        parameters={
            "mdb_id": "cloud-one-mdb-stage",
            "dry_run": False,
        },
